  ...
  return (
    <div style={{ display: "grid", gap: "14px" }}>
      <Card style={{ padding: "18px" }}>
        <h2 style={{ margin: 0, fontSize: "22px", color: t.text }}>Simulação de gastos</h2>
      ...
      >
        <Card style={{ padding: "16px" }}>
          ...
          <h3 style={{ marginTop: "10px", color: simulatedBalance >= 0 ? t.positive : t.negative }}>
        ...
        <Card style={{ padding: "16px" }}>
          ...
          <h3 style={{ marginTop: "10px", color: simulatedDaily >= 0 ? t.accent : t.negative }}>
      ...
      <Card style={{ padding: "16px" }}>
        ...
        <form onSubmit={handleAddSimExpense} style={{ display: "grid", gap: "12px", marginTop: "12px" }}>
          <input
            type="text"
      ...
      <Card style={{ padding: "16px" }}>
        ...
        {simExpenses.length === 0 ? (
          <p style={{ marginTop: "12px", color: t.textSub }}>Nenhum gasto simulado ainda.</p>
        ) : (
